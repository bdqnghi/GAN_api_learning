...
def compute_candidates_for_method_similarity(src_dico,tgt_dico,params, file_path = None):
        ...
        for src_token, src_index  in src_dico.items():
            ...
            for tgt_token, tgt_index in tgt_dico.items():
                ...
                if (".".join(src_class_method) == ".".join(tgt_class_method)) or (src_token == tgt_token):
                    ...
                    # candidate_pair = src_token + "-" + tgt_token
                    # candidate_pairs.append(candidate_pair)

                    # candidate_index = str(src_index) + "-" + str(tgt_index)
