...
from ..dico_builder import get_candidates_2
...
class Evaluator(object):
    ...
    def dist_mean_cosine(self, to_log, mutual_nn=0):
        """
        ...
        for dico_method in ['nn', 'csls_knn_10']:
            ...
            _params.dico_max_rank = dico_max_rank
            ...
            # s2t_candidates = None
            # t2s_candidates = None
            dico = build_dictionary(src_emb, tgt_emb, mutual_nn, _params, s2t_candidates, t2s_candidates)
            # mean cosine
            if dico is None:
                mean_cosine = -1e9
            else:
    ...
    def all_eval(self, to_log, mutual_nn):
        """
        Run all evaluations.
        """
        ...
        self.dist_mean_cosine(to_log, mutual_nn)
