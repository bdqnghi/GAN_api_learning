...
VALIDATION_METRIC = 'mean_cosine-csls_knn_10-S2T|T2S-1000'
...
parser.add_argument("--dis_most_frequent", type=int, default=500, help="Select embeddings of the k most frequent words for discrimination (0 to disable)")
...
parser.add_argument("--dico_method", type=str, default='nn', help="Method used for dictionary generation (nn/invsm_beta_30/csls_knn_10)")
...
compute_candidates_for_method_similarity(params.src_dico.word2id, params.tgt_dico.word2id, params, "dict/candidates_dict.txt")
logger.info("Num of synthetic class-method dictionary : " + str(len(params.src_candidate_indices)))
"""
...
if params.n_refinement > 0:
    ...
    for n_iter in range(params.n_refinement):
        ...
        trainer.build_dictionary(mutual_nn)
        # apply the Procrustes solution
        trainer.procrustes()

        # embeddings evaluation
        to_log = OrderedDict({'n_iter': n_iter})
        evaluator.all_eval(to_log,mutual_nn)
